...
public class expdelete extends HttpServlet {
    ...
    Conexion con=Conexion.getConexion();
     ...
     ExpelabJpaController idio=new ExpelabJpaController(con.getBd());
    idio.destroy(idP);
     ...
     request.getRequestDispatcher("explab.jsp").forward(request, response);
               ...
               Logger.getLogger(expdelete.class.getName()).log(Level.SEVERE, null, ex);
           response.sendRedirect("explab.jsp");
