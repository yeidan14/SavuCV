 ...
 * @author PC
 */
public class RegistrarExpeLab extends HttpServlet {
   ...
   if(empres.equals("")||tempres.equals("")||paisempresa.equals("")||dptoempres.equals("")||munempres.equals("")||correoEmpresa.equals("")||telefono.equals("")||fechaingreso.equals("")||fechaReiro.equals("")
          ||cargo.equals("")||dependecia.equals("")||direccion.equals("")){
        String tipo = "expincompleta";
   ...
   expe.create(ex);
    ...
    request.setAttribute("nombre", tipo);
     request.getRequestDispatcher("explab.jsp").forward(request, response);
               ...
               Logger.getLogger(RegistrarExpeLab.class.getName()).log(Level.SEVERE, null, ex);
