 ...
 * @author PC
 */
public class deleteidioma extends HttpServlet {
   ...
   throws ServletException, IOException {
    ...
    Conexion con=Conexion.getConexion();
     ...
     IdiomaJpaController idio=new IdiomaJpaController(con.getBd());
    idio.destroy(idP);
     String tipo = "idiomaeliminada";
                    request.setAttribute("nombre", tipo);
     request.getRequestDispatcher("idiomas.jsp").forward(request, response);
         
        }catch(Exception ex){
               Logger.getLogger(EdSuperior.class.getName()).log(Level.SEVERE, null, ex);
